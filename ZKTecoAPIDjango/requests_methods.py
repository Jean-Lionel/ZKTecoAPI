...
class ZKTeco:
	...
	def purifyConf(self, block: str) -> dict:
		# block_list = block\
	...
	def logs(self, id_user, sdate=None, edate=None, tryout=True) ->str:
		# print(f"Lionel SDATE {sdate} est hacker EDATE {edate}")
		edate = edate if edate else str(date.today())
		sdate = sdate if sdate else str(date.today())
